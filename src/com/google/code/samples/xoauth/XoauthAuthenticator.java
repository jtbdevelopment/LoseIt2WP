...
public class XoauthAuthenticator {
  public static final class XoauthProvider extends Provider {
    ...
    public static final String name = "Google Xoauth Provider";
  }
  ...
  public static void initialize() {
    Security.removeProvider(XoauthProvider.name);
  ...
  public static SMTPTransport connectToSmtp(String host,
                                            ...
                                            OAuthConsumer consumer,
                                            boolean debug) throws Exception {
    Session session = getSessionForSmtp(debug);

    return connectToSmtp(session, host, port, userEmail, oauthToken, oauthTokenSecret, consumer);
  }

    public static SMTPTransport connectToSmtp(Session session, String host, int port, String userEmail, String oauthToken, String oauthTokenSecret, OAuthConsumer consumer) throws MessagingException, IOException, OAuthException, URISyntaxException {
        final URLName unusedUrlName = null;
    ...
    public static Session getSessionForSmtp(boolean debug) {
      Properties props = new Properties();
...
email = "52weeks52pounds@gmail.com";
      oauthToken = "1/plf7hPlaW4ChfjhRsE9EyweFczS_yC8Yrg2gAPqYn_A";
              oauthTokenSecret="qyIUdxJu4PsxTvDkZrBwtUx2";
    ...
    IMAPSSLStore imapSslStore = connectToImap("imap.googlemail.com",
                                              ...
                                              true);
Folder folder = imapSslStore.getFolder("Inbox");
folder.open(Folder.READ_ONLY);
System.out.println("HEY LOOK AT ME" + folder.getMessages().length);
folder.close(false);
