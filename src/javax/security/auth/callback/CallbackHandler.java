 ...
 * {@link javax.security.auth.callback.Callback}s. A single method {@link #handle(javax.security.auth.callback.Callback[])} must be
...
public interface CallbackHandler {
    ...
    /**
     * Handles the actual {@link javax.security.auth.callback.Callback}. A {@code CallbackHandler} needs to
